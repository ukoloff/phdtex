...
\include{\template/synopsis-parts/synopsis-title}
\resetHeadWidth

% текст введения находится в introduction.tex
\input{parts/intro-syn}
% содержание работы по главам, основные результаты и выводы
\input{synopsis-parts/synopsis-content}
\input{synopsis-parts/synopsis-results}
% основные публикации по теме диссертации
\input{\template/synopsis-parts/synopsis-references.tex}
